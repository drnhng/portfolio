export const projects = [
    {
      ...
      longDescription: "A comprehensive social platform that allows users to curate and share content. I led a team of three engineers to build Silknode, a social curation app, from the ground up. I designed the architecture and database, translated Figma designs into interactive React components, and optimized performance with caching, SSR, and lazy loading.",
